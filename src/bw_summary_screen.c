...
{
    AddTextPrinterParameterized4(windowId, FONT_SHORT_NARROW, x, y, 0, lineSpacing, sTextColors[colorId], 0, string);
}
...
static void SetMonTypeIcons(void)
{
    ...
    else
    {
        ...
        {
            SetTypeSpritePosAndPal(gSpeciesInfo[summary->species].types[1], 103, 46, SPRITE_ARR_ID_TYPE + 1);
        ...
        {
            SetTypeSpritePosAndPal(summary->teraType, 138, 46, SPRITE_ARR_ID_TYPE + 2);
        }
    }
}
