...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_SCEPTILE_TERA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_CULTIVATE, ABILITY_CHLOROPHYLL, ABILITY_UNBURDEN },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Sceptile"),
        .cryId = CRY_SCEPTILE,
        .natDexNum = NATIONAL_DEX_SCEPTILE,
    ...
    [SPECIES_BLAZIKEN_TERA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_LUMINOUS, ABILITY_QUICK_FEET, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Blaziken"),
        .cryId = CRY_BLAZIKEN,
        .natDexNum = NATIONAL_DEX_BLAZIKEN,
        ...
        .trainerScale = 301,
        .trainerOffset = 4,
        .frontPic = gMonFrontPic_BlazikenTera,
        .frontPicFemale = gMonFrontPic_BlazikenTera,
        .frontPicSize = MON_COORDS_SIZE(56, 64),
        .frontPicSizeFemale = MON_COORDS_SIZE(56, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_Blaziken,
        .frontAnimId = ANIM_H_SHAKE,
        .backPic = gMonBackPic_BlazikenTera,
        .backPicFemale = gMonBackPic_BlazikenTera,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicSizeFemale = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        .palette = gMonPalette_BlazikenTera,
        .shinyPalette = gMonShinyPalette_BlazikenTera,
        .iconSprite = gMonIcon_BlazikenTera,
        .iconPalIndex = 0,
        SHADOW(4, 8, SHADOW_SIZE_M)
        FOOTPRINT(Blaziken)
        .isTeraForm = TRUE,
    ...
    [SPECIES_SWAMPERT_TERA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_PYROCLAST, ABILITY_DAMP, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Swampert"),
        .cryId = CRY_SWAMPERT,
        .natDexNum = NATIONAL_DEX_SWAMPERT,
    ...
    [SPECIES_ZIGZAGOON] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_PICKUP, ABILITY_GLUTTONY, ABILITY_GUTS },
    #else
    ...
    [SPECIES_WURMPLE] =
    {
        ...
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_EFFECT_SPORE, ABILITY_RUN_AWAY },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SILCOON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHED_SKIN, ABILITY_EFFECT_SPORE, ABILITY_STAMINA },
        .bodyColor = BODY_COLOR_WHITE,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_PLUSLE] =
    {
        ...
        .abilities = { ABILITY_PLUS, ABILITY_NONE, ABILITY_TRIAGE },
    #else
    ...
    [SPECIES_MINUN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_MINUS, ABILITY_NONE, ABILITY_GALVANIZE },
    #else
    ...
    [SPECIES_ROSERADE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_GRASS),
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_LEAF_GUARD, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_NUMEL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_SIMPLE, ABILITY_DROUGHT },
    #else
    ...
    [SPECIES_CAMERUPT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_SOLID_ROCK, ABILITY_DROUGHT },
    #else
    ...
    [SPECIES_TRAPINCH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #endif
        .abilities = { ABILITY_SAND_VEIL, ABILITY_ARENA_TRAP, ABILITY_DRAGONS_MAW },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_VIBRAVA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #endif
        .abilities = { ABILITY_SAND_VEIL, ABILITY_LEVITATE, ABILITY_DRAGONS_MAW },
        .bodyColor = BODY_COLOR_GREEN,
