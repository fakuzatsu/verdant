...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_BURMY_PLANT] =
    {
        ...
        .eggMoveLearnset = sBurmyEggMoveLearnset,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_CHATOT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_PUNK_ROCK, ABILITY_TANGLED_FEET, ABILITY_PRANKSTER},
    ...
    [SPECIES_MESPRIT] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_FRIEND_GUARD },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_AZELF] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_DEFIANT },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Azelf"),
        .cryId = CRY_AZELF,
