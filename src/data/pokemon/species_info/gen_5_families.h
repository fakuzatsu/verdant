...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_MUNNA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_COMATOSE, ABILITY_COMATOSE, ABILITY_BERSERK },
    ...
    [SPECIES_SEWADDLE] =
    {
        ...
        .abilities = { ABILITY_OVERCOAT, ABILITY_CHLOROPHYLL, ABILITY_SUPER_LUCK },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_DWEBBLE] =
    {
        ...
        .abilities = { ABILITY_SAND_RUSH, ABILITY_SHELL_ARMOR, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_AXEW] =
    {
        ...
        .abilities = { ABILITY_RIVALRY, ABILITY_UNNERVE, ABILITY_STEELWORKER },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Axew"),
        .cryId = CRY_AXEW,
