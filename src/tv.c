...
void BravoTrainerPokemonProfile_BeforeInterview2(u8 contestStandingPlace)
{
    ...
    if (sCurTVShowSlot != -1)
    {
        ...
        show->bravoTrainer.pokemonNameLanguage = LANGUAGE_ENGLISH;
    }
}
...
void PutNameRaterShowOnTheAir(void)
{
    ...
    if (gSpecialVar_Result != 1)
    {
        ...
        if (StringLength(gSaveBlock2Ptr->playerName) > 1 && StringLength(gStringVar1) > 1)
        {
            ...
            show->nameRaterShow.pokemonNameLanguage = LANGUAGE_ENGLISH;
        }
    }
}
...
static void InterviewAfter_PkmnFanClubOpinions(void)
{
    ...
    show->fanclubOpinions.pokemonNameLanguage = LANGUAGE_ENGLISH;
}
...
void TryPutSpotTheCutiesOnAir(struct Pokemon *pokemon, u8 ribbonMonDataIdx)
{
    ...
    if (sCurTVShowSlot != -1 && IsRecordMixShowAlreadySpawned(TVSHOW_CUTIES, FALSE) != TRUE)
    {
        ...
        show->cuties.pokemonNameLanguage = LANGUAGE_ENGLISH;
    }
}
...
static bool8 IsPartyMonNicknamedOrNotEnglish(u8 monIdx)
{
    ...
    if (!StringCompare(GetSpeciesName(GetMonData(pokemon, MON_DATA_SPECIES, NULL)), gStringVar1))
        return FALSE;
...
static void DoTVShowSpotTheCuties(void)
{
    ...
    case SPOTCUTIES_STATE_RIBBON_INTRO:
        ...
        case TRAVELLER_RIBBON:
            ...
            break;
        case HISTORIC_RIBBON:
            sTVShowState = SPOTCUTIES_STATE_RIBBON_HISTORIC;
            break;
