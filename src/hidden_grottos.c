...
{
    {MAP_NUM(MAP_GROTTO01), MAP_GROUP(MAP_GROTTO01)},
    {MAP_NUM(MAP_GROTTO02), MAP_GROUP(MAP_GROTTO02)},
    {MAP_NUM(MAP_GROTTO03), MAP_GROUP(MAP_GROTTO03)},
    {MAP_NUM(MAP_GROTTO04), MAP_GROUP(MAP_GROTTO04)},
    {MAP_NUM(MAP_GROTTO05), MAP_GROUP(MAP_GROTTO05)},
    {MAP_NUM(MAP_GROTTO06), MAP_GROUP(MAP_GROTTO06)},
    {MAP_NUM(MAP_GROTTO07), MAP_GROUP(MAP_GROTTO07)},
    {MAP_NUM(MAP_GROTTO08), MAP_GROUP(MAP_GROTTO08)},
    //{MAP_NUM(MAP_GROTTO09), MAP_GROUP(MAP_GROTTO09)},
    //{MAP_NUM(MAP_GROTTO10), MAP_GROUP(MAP_GROTTO10)},
    //{MAP_NUM(MAP_GROTTO11), MAP_GROUP(MAP_GROTTO11)},
    //{MAP_NUM(MAP_GROTTO12), MAP_GROUP(MAP_GROTTO12)},
    //{MAP_NUM(MAP_GROTTO13), MAP_GROUP(MAP_GROTTO13)},
    //{MAP_NUM(MAP_GROTTO14), MAP_GROUP(MAP_GROTTO14)},
    //{MAP_NUM(MAP_GROTTO15), MAP_GROUP(MAP_GROTTO15)},
    //{MAP_NUM(MAP_GROTTO16), MAP_GROUP(MAP_GROTTO16)},
    //{MAP_NUM(MAP_GROTTO17), MAP_GROUP(MAP_GROTTO17)},
    //{MAP_NUM(MAP_GROTTO18), MAP_GROUP(MAP_GROTTO18)},
    //{MAP_NUM(MAP_GROTTO19), MAP_GROUP(MAP_GROTTO19)},
    //{MAP_NUM(MAP_GROTTO20), MAP_GROUP(MAP_GROTTO20)},
    //{MAP_NUM(MAP_GROTTO21), MAP_GROUP(MAP_GROTTO21)},
    //{MAP_NUM(MAP_GROTTO22), MAP_GROUP(MAP_GROTTO22)},
    //{MAP_NUM(MAP_GROTTO23), MAP_GROUP(MAP_GROTTO23)},
    //{MAP_NUM(MAP_GROTTO24), MAP_GROUP(MAP_GROTTO24)},
    //{MAP_NUM(MAP_GROTTO25), MAP_GROUP(MAP_GROTTO25)},
    //{MAP_NUM(MAP_GROTTO26), MAP_GROUP(MAP_GROTTO26)},
    //{MAP_NUM(MAP_GROTTO27), MAP_GROUP(MAP_GROTTO27)},
    //{MAP_NUM(MAP_GROTTO28), MAP_GROUP(MAP_GROTTO28)},
    //{MAP_NUM(MAP_GROTTO29), MAP_GROUP(MAP_GROTTO29)},
    //{MAP_NUM(MAP_GROTTO30), MAP_GROUP(MAP_GROTTO30)},
};

static const struct GrottoEntrance sHiddenGrottoEntrances[] = 
{
    {MAP_NUM(MAP_ROUTE103), MAP_GROUP(MAP_ROUTE103), VAR_HIDDEN_GROTTO_ROUTE_103,       1}, // Yes
    {MAP_NUM(MAP_ROUTE104), MAP_GROUP(MAP_ROUTE104), VAR_HIDDEN_GROTTO_PETALBURG_WOODS, 6}, // Yes
    {MAP_NUM(MAP_ROUTE112), MAP_GROUP(MAP_ROUTE112), VAR_HIDDEN_GROTTO_ROUTE_112,       6}, // Yes
    {MAP_NUM(MAP_ROUTE117), MAP_GROUP(MAP_ROUTE117), VAR_HIDDEN_GROTTO_ROUTE_117,       1}, // Yes
    {MAP_NUM(MAP_ROUTE119), MAP_GROUP(MAP_ROUTE119), VAR_HIDDEN_GROTTO_ROUTE_119,       2}, // Yes
    {MAP_NUM(MAP_ROUTE120), MAP_GROUP(MAP_ROUTE120), VAR_HIDDEN_GROTTO_ROUTE_120,       2}, // Yes
    {MAP_NUM(MAP_ROUTE121), MAP_GROUP(MAP_ROUTE121), VAR_HIDDEN_GROTTO_ROUTE_121,       1}, // Yes
    {MAP_NUM(MAP_ROUTE123), MAP_GROUP(MAP_ROUTE123), VAR_HIDDEN_GROTTO_ROUTE_123,       1}, // Yes
};
