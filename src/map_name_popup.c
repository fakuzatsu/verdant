...
static const u8 sMapSectionToThemeId[MAPSEC_COUNT - KANTO_MAPSEC_COUNT - 1] =
{
    ...
    [MAPSEC_HIDDEN_GROTTO - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_THUNDER_ROCK - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_MYTHIC_STONE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
};
...
static const u8 sMapSectionToThemeId_BW[MAPSEC_COUNT - KANTO_MAPSEC_COUNT - 1] =
{
    ...
    [MAPSEC_HIDDEN_GROTTO - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_THUNDER_ROCK - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MYTHIC_STONE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
};
...
static void LoadMapNamePopUpWindowBg(void)
{
    ...
    if (OW_POPUP_GENERATION == GEN_5)
    {
        popUpThemeId = sMapSectionToThemeId_BW[regionMapSectionId];
        switch (popUpThemeId)
        {
