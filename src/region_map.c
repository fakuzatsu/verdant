...
static const u32 sFlyTargetIcons_Gfx[] = INCBIN_U32("graphics/pokenav/region_map/fly_target_icons.4bpp.fastSmol");
...
static void InitMapBasedOnPlayerLocation(void)
{
    ...
    case MAPSEC_ROUTE_119:
        if ((gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(MAP_ROUTE119_NORTH)
            && gSaveBlock1Ptr->location.mapNum == MAP_NUM(MAP_ROUTE119_NORTH))
            || (gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(MAP_THUNDER_ROCK)
