...
const u8 gText_HiddenGrotto[] = _("Hidden Grotto");
...
const u8 gText_OptionMatchCalls[] = _("DexNav Calls");    //tx_optionsPlus
...
const u8 gText_MoveRelearnerStopTryingToTeachMove[] = _("Keep trying to teach\n{STR_VAR_2}?");
