...
static EWRAM_DATA u8 (* sListMenuStringsBuffer)[MOVE_NAME_LENGTH * 2] = NULL;
...
static bool8 HandleLoadTMCaseGraphicsAndPalettes(void)
{
    ...
    case 1:
        ...
        {
            DecompressDataWithHeaderWram(gUnknown_8E84A24, sTilemapBuffer);
            sTMCaseDynamicResources->seqId++;
        }
        break;
    case 2:
        // DecompressDataWithHeaderWram(gUnknown_8E84B70, GetBgTilemapBuffer(1)); //TM case bg graphic
        sTMCaseDynamicResources->seqId++;
        break;
    case 3:
...
static void CreateTMCaseListMenuBuffers(void)
{
    ...
    sListMenuStringsBuffer = Alloc(sTMCaseDynamicResources->numTMs * (MOVE_NAME_LENGTH * 2));
}
