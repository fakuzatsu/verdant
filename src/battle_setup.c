...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_JUAN] = REMATCH(TRAINER_WALLACE, TRAINER_JUAN_2, TRAINER_JUAN_3, TRAINER_JUAN_4, TRAINER_JUAN_5, SOOTOPOLIS_CITY),
    ...
    [REMATCH_WALLACE] = REMATCH(TRAINER_STEVEN_CHAMPION, TRAINER_STEVEN_CHAMPION, TRAINER_STEVEN_CHAMPION, TRAINER_STEVEN_CHAMPION, TRAINER_STEVEN_CHAMPION, EVER_GRANDE_CITY),
};
