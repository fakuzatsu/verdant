...
static const u16 sRandomSpeciesForSpecialEgg[] =
{
    ...
    SPECIES_GROOKEY, SPECIES_SCORBUNNY, SPECIES_SOBBLE, SPECIES_PHIONE, SPECIES_GROWLITHE_HISUI, SPECIES_SNEASEL_HISUI, SPECIES_ZORUA_HISUI,
...
{
    return sRandomSpeciesForEgg[Random() % ARRAY_COUNT(sRandomSpeciesForEgg)];
}
