...
static const u8 sBerryDescriptionPart1_WatmelMetric[] = _("A huge Berry, with some over half a");
static const u8 sBerryDescriptionPart2_WatmelMetric[] = _("meter discovered. Exceedingly sweet.");
