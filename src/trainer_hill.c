...
static const u16 sPrizeListSunnyDay[]    = {ITEM_TM_TEMPER_FLARE,  ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
...
static const u16 sPrizeListTorment[]     = {ITEM_TM_FLARE_BLITZ,   ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
