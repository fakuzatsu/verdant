...
static const struct FlashStruct sTransitionTypes[] =
{
    ...
    {MAP_TYPE_HIDDEN_GROTTO, MAP_TYPE_ROUTE,     FALSE,  TRUE, DoExitCaveTransition},
    {MAP_TYPE_ROUTE, MAP_TYPE_HIDDEN_GROTTO,     TRUE,  FALSE, DoEnterCaveTransition},
    {},
};
...
static const u32 sCaveTransitionTiles[] = INCBIN_U32("graphics/cave_transition/tiles.4bpp.fastSmol");
