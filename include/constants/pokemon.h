...
#define SPECIAL_MEMORY_START 24

enum PokemonMemories
{
    MEMORY_NONE,
    MEMORY_WONDER_TRADE,
    MEMORY_LINK_TRADE,
    MEMORY_COOL_CONTEST,
    MEMORY_BEAUTY_CONTEST,
    MEMORY_CUTE_CONTEST,
    MEMORY_CLEVER_CONTEST,
    MEMORY_TOUGH_CONTEST,
    MEMORY_COOL_POKEBLOCK,
    MEMORY_BEAUTY_POKEBLOCK,
    MEMORY_CUTE_POKEBLOCK,
    MEMORY_CLEVER_POKEBLOCK,
    MEMORY_TOUGH_POKEBLOCK,
    MEMORY_DISLIKED_POKEBLOCK,
    MEMORY_LOVED_POKEBLOCK,
    MEMORY_MAXED_OUT_SHEEN,
    MEMORY_ROXANNE_GYM,
    MEMORY_BRAWLY_GYM,
    MEMORY_WATTSON_GYM,
    MEMORY_FLANNERY_GYM,
    MEMORY_NORMAN_GYM,
    MEMORY_WINONA_GYM,
    MEMORY_TATE_LIZA_GYM,
    MEMORY_JUAN_GYM,
    MEMORY_ELITE_FOUR,
    MEMORY_SIG_TRAINER,
    MEMORY_SILVER_FRONTIER,
    MEMORY_LEGENDARY_CATCH,
    MEMORY_CHAMPION_TITLE_DEF,
    MEMORY_MASTER_CONTEST,
    MEMORY_SAVED_THE_WORLD,
    MEMORY_GOLD_FRONTIER,
    MEMORY_COUNT,
};
