...
#define OPTIONS_UNITS_IMPERIAL 0
#define OPTIONS_UNITS_METRIC 1

#define OPTIONS_FONT_EMERALD 0
#define OPTIONS_FONT_FIRERED 1

#define OPTIONS_DIFFICULTY_EASY 0
#define OPTIONS_DIFFICULTY_HARD 1
#define OPTIONS_DIFFICULTY_DOUBLES 2

#define OPTIONS_LEVEL_CAPS_OFF 0
#define OPTIONS_LEVEL_CAPS_SOFT 1
#define OPTIONS_LEVEL_CAPS_HARD 2

#define OPTIONS_DRAFT_ALL_OFF 0
#define OPTIONS_DRAFT_ONLY_DRAFT 1
#define OPTIONS_DRAFT_ON_PLUS_BO3 2
