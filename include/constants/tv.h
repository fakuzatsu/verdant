...
#define SPOTCUTIES_STATE_RIBBON_TENT      15
#define SPOTCUTIES_STATE_RIBBON_TRAVELLER 16
#define SPOTCUTIES_STATE_RIBBON_HISTORIC  17
#define SPOTCUTIES_STATE_OUTRO            18
