...
#define MOVE_AQUATIC_BLOOM      (FIRST_TERA_MOVE + 2)
#define MOVE_SOLAR_KICK         (FIRST_TERA_MOVE + 3)
#define MOVE_MAGMA_SPIN         (FIRST_TERA_MOVE + 4)
#define MOVE_SPIRIT_CHRONICLE   (FIRST_TERA_MOVE + 5)

#define FIRST_TERA_MOVE         MOVES_COUNT_DYNAMAX
#define LAST_TERA_MOVE          MOVE_SPIRIT_CHRONICLE
