...
#define POKEDEX_PLUS_SKIP_GAPS       TRUE    // if TRUE, skips over gaps in the Pokedex, displaying triple bullets to indicate missing entries.
#define SKIP_THRESHOLD               4       // Number of Pokémon to check are unseen before triggering a skip as above.
...
#define UNITS                        UNITS_IMPERIAL // Obsoleted by New Options Plus which has its own internal option.
