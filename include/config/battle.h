...
#define B_CATCH_UP_EXP              FALSE      // All Pokémon who gain exp recieve an increased amount based on how many levels they are below your highest level party member.
...
#define B_FLAG_SLEEP_CLAUSE         FLAG_SYS_SLEEP_CAUSE // If this flag is set, sleep clause is enabled; if the player / AI has already put a Pokémon on the opponent's side to sleep and it is still sleeping, another one can't be put to sleep.
                                          // AI requires AI_FLAG_CHECK_BAD_MOVE to understand.
...
// Menu settings
#define B_MOVE_DESCRIPTION_BUTTON   L_BUTTON   // If this button is defined, you can click it to see move descriptions during battles.
...
#define B_PREFERRED_ICE_WEATHER         B_ICE_WEATHER_SNOW // Toggles Hail move effects to Snow and vis versa. 
...
#define B_POOL_SETTING_FIXED_SEED           0x3C12   // "Random" number -it's ざつ in Emerald charmap which should spell zatsu
